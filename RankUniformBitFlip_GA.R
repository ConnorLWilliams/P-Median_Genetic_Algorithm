...
RankTwoPointBitFlip <- function(maxEpochs, Population, loc_scatter, pop_size) {
  newPopulation <- Population
  fit_over_time <- c()
...
RouletteUniformBitFlip <- function(maxEpochs, Population, loc_scatter, pop_size) {
  newPopulation <- Population
  fit_over_time <- c()
  ...
  for(i in 1:maxEpochs) { #Run for a maximum number of Epochs
    ...
    for(sel in 1:pop_size/2) { #Create next generation using crossovers (100% crossover rate)
      #Selection
      p1 <- roul_selection(generation_rank, sum(generation_rank[, 3]))
      p2 <- roul_selection(generation_rank, sum(generation_rank[, 3]))
...
RouletteTwoPointBitFlip <- function(maxEpochs, Population, loc_scatter, pop_size) {
  newPopulation <- Population
  fit_over_time <- c()
...
RankUniformNBitFlip <- function(maxEpochs, Population, loc_scatter, pop_size) {
  newPopulation <- Population
  fit_over_time <- c()
...
RankTwoPointNBitFlip <- function(maxEpochs, Population, loc_scatter, pop_size) {
  newPopulation <- Population
  fit_over_time <- c()
...
RouletteUniformNBitFlip <- function(maxEpochs, Population, loc_scatter, pop_size) {
  newPopulation <- Population
  fit_over_time <- c()
...
RouletteTwoPointNBitFlip <- function(maxEpochs, Population, loc_scatter, pop_size) {
  newPopulation <- Population
  fit_over_time <- c()
